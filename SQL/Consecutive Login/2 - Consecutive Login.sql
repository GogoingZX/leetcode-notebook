...
WITH login_info AS (
    SELECT
        ...
        ,user_name
        ,login_date
        ,login_date - interval '1' day * rn AS refer_date -- NOTE: https://stackoverflow.com/questions/15160207/how-to-add-a-variable-number-of-hours-to-a-date-in-postgresql
    FROM (
        SELECT
            user_id
            ,user_name
